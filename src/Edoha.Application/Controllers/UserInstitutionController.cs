...
namespace Edoha.Controllers
{
    ...
    public class UserInstitutionController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateUserInstitutionRequest request)
        {
            if(request != null)
            {
                try
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateUserInstitutionRequest request)
        {
            if (request != null)
            {
                try
